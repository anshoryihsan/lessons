...
const Content = () => {
    return(<>
        ...
        <div class="bg-primary side-nav-right p-4 shadow-sm">
          <div class="d-md-flex justify-content-between">
            <div>
              <div class="text-white">Balance</div>
              <h2 class="my-3 text-white font-weight-bold">Rp 120.000</h2>
              <div class="small text-white">+62 813-9387-7946</div>
            </div>
            ...
            >
              <button
                class="btn bg-white-outline py-3 mb-md-2 text-white d-flex overlay-1"
              >
                <img
              ...
              <button
                class="btn bg-white-outline py-3 mb-md-2 px-3 text-white d-flex overlay-1"
              >
                <img
